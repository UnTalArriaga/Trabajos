...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		glm::mat4 temp, tempd;
		//Model
		/***************** Letra t y g controla hombro ***************/
		/***************** Letra y y h controla codo ***************/
		/***************** Letras u y j  controla articulaciones C, E, G, I ***************/
		/***************** Letra i y k controla articulaciones D, F, H, J ***************/
		glBindVertexArray(VAO);
		...
		temp = modelOp = glm::translate(modelOp, glm::vec3(1.25f, 0.0f, 0.0f));
		modelOp = glm::scale(modelOp, glm::vec3(2.5f, 1.0f, 1.0f));
		myShader.setMat4("model", modelOp);
		myShader.setVec3("aColor", glm::vec3(1.0f, 1.0f, 0.0f));
		glDrawArrays(GL_TRIANGLES, 0, 36);	//B

		modelOp = glm::translate(temp, glm::vec3(1.25f, -0.35f, 0.375f));
		modelOp = glm::rotate(modelOp, glm::radians(de), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		modelOp = glm::rotate(modelOp, glm::radians(df), glm::vec3(0.0f, 1.0f, 0.0f));
		tempd = modelOp = glm::translate(modelOp, glm::vec3(0.25f, 0.0f, 0.0f));
		modelOp = glm::scale(modelOp, glm::vec3(0.5f, 0.3f, 0.25f));
		myShader.setMat4("model", modelOp);
		...
		modelOp = glm::translate(temp, glm::vec3(1.25f, 0.35f, 0.375f));
		modelOp = glm::rotate(modelOp, glm::radians(dc), glm::vec3(0.0f, 0.0f, 1.0f));
		tempd = modelOp = glm::translate(modelOp, glm::vec3(0.25f, 0.0f, 0.0f));
		modelOp = glm::scale(modelOp, glm::vec3(0.5f, 0.3f, 0.25f));
		myShader.setMat4("model", modelOp);
		...
		modelOp = glm::translate(tempd, glm::vec3(0.25f, 0.0f, 0.0f));
		modelOp = glm::rotate(modelOp, glm::radians(dd), glm::vec3(0.0f, 0.0f, 1.0f));
		tempd = modelOp = glm::translate(modelOp, glm::vec3(0.375f, 0.0f, 0.0f));
		...
		modelOp = glm::translate(temp, glm::vec3(1.25f, 0.35f, 0.0f));
		modelOp = glm::rotate(modelOp, glm::radians(dc), glm::vec3(0.0f, 0.0f, 1.0f));
		tempd = modelOp = glm::translate(modelOp, glm::vec3(0.375f, 0.0f, 0.0f));
		modelOp = glm::scale(modelOp, glm::vec3(0.75f, 0.3f, 0.25f));
		myShader.setMat4("model", modelOp);
		...
		modelOp = glm::translate(tempd, glm::vec3(0.375f, 0.0f, 0.0f));
		modelOp = glm::rotate(modelOp, glm::radians(dd), glm::vec3(0.0f, 0.0f, 1.0f));
		tempd = modelOp = glm::translate(modelOp, glm::vec3(0.5f, 0.0f, 0.0f));
...
void my_input(GLFWwindow* window)
{
	...
	if (glfwGetKey(window, GLFW_KEY_G) == GLFW_PRESS && -120.0f < hombro)
		hombro -= 1.0f;
	//Rotacion Codo
	if (glfwGetKey(window, GLFW_KEY_Y) == GLFW_PRESS && 2.0f > codo)
		codo += 1.0f;
	if (glfwGetKey(window, GLFW_KEY_H) == GLFW_PRESS && -110.0 < codo)
		codo -= 1.0f;

	//Rotacion E
	//if (glfwGetKey(window, GLFW_KEY_U) == GLFW_PRESS && 45.0f > de)
	//	de += 1.0f;
	//if (glfwGetKey(window, GLFW_KEY_J) == GLFW_PRESS && -30.0 < de)
	//	de -= 1.0f;
	////Rotacion F
	//if (glfwGetKey(window, GLFW_KEY_I) == GLFW_PRESS && 90.0f > df)
	//	df += 1.0f;
	//if (glfwGetKey(window, GLFW_KEY_K) == GLFW_PRESS && -10.0 < df)
	//	df -= 1.0f;
