...
void LoadTextures()
{
	...
	t_Kendrick = generateTextures("Texturas/Kendrick.jpg", 0); //generateTextures("Dir de la imagen/textura", Si la textura tiene transparencias 1=true); 
	t_calabaza = generateTextures("Texturas/Calabaza.png", 1);
...
void myData()
{
	...
	GLfloat verticesCubo[] = {
		...
		-0.5f, -0.5f, 0.5f,		0.25f, 0.66666f,	//V0 - Frontal
		0.5f, -0.5f, 0.5f,		0.5f, 0.66666f,	//V1
		0.5f, 0.5f, 0.5f,		0.5f, 1.0f,		//V5
		-0.5f, -0.5f, 0.5f,		0.25f, 0.66666f,	//V0
		-0.5f, 0.5f, 0.5f,		0.25f, 1.0f,	//V4
		0.5f, 0.5f, 0.5f,		0.5f, 1.0f,		//V5

		0.5f, -0.5f, -0.5f,		0.5f, 0.33f,	//V2 - Trasera
		-0.5f, -0.5f, -0.5f,	0.25f, 0.33f,	//V3
		-0.5f, 0.5f, -0.5f,		0.25f, 0.0f,	//V7
		0.5f, -0.5f, -0.5f,		0.5f, 0.33f,	//V2
		...
		0.5f, 0.5f, 0.5f,		0.75f, 0.66f,	//V5 - Der
		0.5f, -0.5f, 0.5f,		0.5f, 0.66f,	//V1
		0.5f, -0.5f, -0.5f,		0.5f, 0.33f,	//V2
		0.5f, 0.5f, 0.5f,		0.75f, 0.66f,	//V5
		0.5f, 0.5f, -0.5f,		0.75f, 0.33f,	//V6
		0.5f, -0.5f, -0.5f,		0.5f, 0.33f,	//V2

		-0.5f, 0.5f, 0.5f,		1.0f, 0.66f,	//V4 - Sup
		0.5f, 0.5f, 0.5f,		0.75f, 0.66f,	//V5
		0.5f, 0.5f, -0.5f,		0.75f, 0.33f,	//V6
		-0.5f, 0.5f, 0.5f,		1.0f, 0.66f,	//V4
		-0.5f, 0.5f, -0.5f,		1.0f, 0.33f,	//V7
		0.5f, 0.5f, -0.5f,		0.75f, 0.33f,	//V6

		-0.5f, -0.5f, 0.5f,		0.25f, 0.66f,	//V0 - Inf
		-0.5f, -0.5f, -0.5f,	0.25f, 0.33f,	//V3
		0.5f, -0.5f, -0.5f,		0.5f, 0.33f,	//V2
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		myShader.setMat4("model", modelOp);
		myShader.setVec3("aColor", 1.0f, 1.0f, 1.0f);//Modifica el color de la textura, si se quiere el color original se coloca el color blanco
		glBindTexture(GL_TEXTURE_2D, t_calabaza);//Se coloca la textura en todo lo que construya a continuacion
